...
import com.example.sabbir.specialcalculator.R;

public abstract class SpecialCalculator extends AppCompatActivity {
    ...
    public KeyboardView.OnKeyboardActionListener keyboardActionListener = new KeyboardView.OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            KeyEvent event =Keyboard keyboard = new Keyboard(PercentDiscountActivity.this, R.xml.keyboards); new KeyEvent(eventTime, eventTime, KeyEvent.ACTION_DOWN, primaryCode, 0, 0, 0, 0, KeyEvent.FLAG_SOFT_KEYBOARD | KeyEvent.FLAG_KEEP_TOUCH_MODE);
